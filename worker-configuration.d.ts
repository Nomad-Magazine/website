/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4fda822be4cf7759505585e82c5c5c50)
// Runtime types generated with workerd@1.20260312.1 2025-06-17 no_handle_cross_request_promise_resolution,nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SMART_SUITE_APIKEY" | "SMART_SUITE_ACCOU[Capgo]: You have been invited to Capgo.appNT_ID" | "SMART_SUITE_TABLE_ID_COMPANY" | "NODE_ENV" | "OPENAI_API_KEY" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "BENTO_SITE_UUID" | "BENTO_PUBLISHABLE_KEY" | "BENTO_SECRET_KEY">> {}
}
